    ...
    async start() {
        ...
        try {
            ...
            server = await preview({
                ...
                preview: {
                    port: Number(this.config?.configSeo?.port) || 4173,
                    strictPort: this.config?.configSeo?.strict || false,
                    open: this.config?.configSeo?.open || false,
                    host: this.config?.configSeo?.host || 'localhost'
                }
            });
